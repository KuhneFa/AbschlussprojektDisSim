...
int018;
Up;
int014(1, 114, 1, 128, 0);
int014(0, 117, 1, 114, 0);
int014(2, 114, 1, 121, 0);
int014(1, 130, 1, 115, 0);
int014(1, 129, 2, 115, 0);
int014(1, 116, 2, 121, 0);
int014(0, 118, 1, 116, 0);
int014(2, 116, 2, 128, 0);
int014(1, 119, 1, 130, 0);
int014(1, 121, 1, 119, 0);
int014(1, 120, 3, 129, 0);
int014(1, 128, 1, 120, 0);
int014(2, 121, 1, 122, 0);
int014(3, 121, 1, 123, 0);
int014(2, 129, 3, 121, 0);
int014(4, 121, 1, 124, 0);
int014(5, 121, 1, 137, 0);
int014(6, 121, 1, 138, 0);
int014(7, 121, 1, 139, 0);
int014(8, 121, 1, 140, 0);
int014(1, 122, 3, 130, 0);
int014(1, 123, 2, 130, 0);
int014(1, 124, 4, 130, 0);
int014(1, 125, 4, 129, 0);
int014(2, 128, 1, 125, 0);
int014(1, 126, 1, 129, 0);
int014(3, 128, 1, 126, 0);
int014(1, 127, 2, 129, 0);
int014(4, 128, 1, 127, 0);
int014(5, 128, 1, 131, 0);
int014(6, 128, 1, 132, 0);
int014(7, 128, 1, 133, 0);
int014(8, 128, 1, 134, 0);
int014(9, 128, 1, 135, 0);
int014(10, 128, 1, 136, 0);
int014(1, 131, 5, 129, 0);
int014(1, 132, 6, 129, 0);
int014(1, 133, 7, 129, 0);
int014(1, 134, 8, 129, 0);
int014(1, 135, 9, 129, 0);
int014(1, 136, 10, 129, 0);
int014(1, 137, 5, 130, 0);
int014(1, 138, 6, 130, 0);
int014(1, 139, 7, 130, 0);
int014(1, 140, 8, 130, 0);
int006(1, 114, 1, 0, 0);
int006(0, 116, 1, 0, 0);
