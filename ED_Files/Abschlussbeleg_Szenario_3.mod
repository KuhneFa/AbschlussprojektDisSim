...
DisableIconRotation(false);
SetProductCode([]);
SetExprAtt(1, [{.Bernoulli(~1,~2,~3)|5. By percentage: ~66~% of products go to channel ~1~, the remaining percentage go to channel ~2~.}Bernoulli(66,1,2)]);
SetAtt(2, 10000);
SetExprAtt(3, [0]);
SetExprAtt(4, [0]);
SetExprAtt(5, [{.content(c)|Fifo (First In First Out).}content(c)]);
...
int018;
Up;
int014(1, 3984, 1, 3998, 0);
int014(0, 3987, 1, 3984, 0);
int014(2, 3984, 1, 3991, 0);
int014(1, 4000, 1, 3985, 0);
int014(1, 3999, 2, 3985, 0);
int014(1, 3986, 2, 3991, 0);
int014(0, 3988, 1, 3986, 0);
int014(2, 3986, 2, 3998, 0);
int014(1, 3989, 1, 4000, 0);
int014(1, 3991, 1, 3989, 0);
int014(1, 3990, 3, 3999, 0);
int014(1, 3998, 1, 3990, 0);
int014(2, 3991, 1, 3992, 0);
int014(3, 3991, 1, 3993, 0);
int014(2, 3999, 3, 3991, 0);
int014(4, 3991, 1, 3994, 0);
int014(1, 3992, 3, 4000, 0);
int014(1, 3993, 2, 4000, 0);
int014(1, 3994, 4, 4000, 0);
int014(1, 3995, 4, 3999, 0);
int014(2, 3998, 1, 3995, 0);
int014(1, 3996, 1, 3999, 0);
int014(3, 3998, 1, 3996, 0);
int014(1, 3997, 2, 3999, 0);
int014(4, 3998, 1, 3997, 0);
int014(5, 3998, 1, 4001, 0);
int014(6, 3998, 1, 4002, 0);
int014(7, 3998, 1, 4003, 0);
int014(8, 3998, 1, 4004, 0);
int014(9, 3998, 1, 4005, 0);
int014(10, 3998, 1, 4006, 0);
int014(1, 4001, 5, 3999, 0);
int014(1, 4002, 6, 3999, 0);
int014(1, 4003, 7, 3999, 0);
int014(1, 4004, 8, 3999, 0);
int014(1, 4005, 9, 3999, 0);
int014(1, 4006, 10, 3999, 0);
int006(1, 3984, 1, 0, 0);
int006(0, 3986, 1, 0, 0);
